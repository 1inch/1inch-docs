...
you can read more about [this](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/)
:::
...
This is part of the `ERC-20` standard, you can read more about [this](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/).
