...
About `slippage`, `disableEstimate`, `allowPartialFill` and other params, please, read [Swap builder params](../swap-builder-params.mdx)
...
![](/img/aggregation-protocol/approve-tx.png)
