...
There is [JavaScript and Typescript compatible library](./utils/about) that solves everything for you, we taking care of it to make everything up to date and make your migration over Limit Order Protocol Versions as smooth as possible.
...
getMakingAmount = '0x'
getTakingAmount = '0x'
expiration = 5444440000 # sometime in the future
