...
As result you will receive a structure of [RFQ order](docs/limit-order-protocol/rfq-limit-orders/limit-order-rfq-structure.mdlimit-orders/limit-order-rfq-structure.md). Example:
