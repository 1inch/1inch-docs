...
See:[ https://www.binance.org/en/bridge](https://www.binance.org/en/bridge) and[ https://zapper.xyz/bridge](https://zapper.xyz/bridge)

**Chi gastoken (CHI) - (***[DEPRECATED](https://blog.1inch.io/ethereums-london-hard-fork-will-make-some-tokens-useless/)***):** CHI both an ERC20 and BEP20 token aimed to help reduce 1inch users' transaction fees. CHI is available on both Ethereum and BNB Chain, and is pegged to the Ethereum and BNB Chain network’s gas price respectively. ***Please note: Due to the EIP1559 hard fork, CHI no longer works as a gas token.
...
**Custom token:** Any ERC20, BEP20, or MRC20 token that is not[ whitelisted](https://help.1inch.io/en/articles/4878336-how-to-get-a-token-listed-on-1inch) on 1inch Network.
...
**[Gas Fees](https://help.1inch.io/en/articles/4585052-what-is-gas-and-why-do-i-need-native-assets-to-pay-for-transaction-fees):** A blockchain transaction fee that compensates validators for their computational and/or capital costs of verifying transactions and adding blocks to the network.

**Gas Limit:** The maximum amount in blockchain gas fees a user is willing to pay for an individual transaction. This amount can be[ custom tailored within the 1inch Wallet](https://help.1inch.io/en/articles/5604671-how-to-set-basic-and-advanced-gas-settings-in-the-1inch-ios-wallet).

**[Governance Staking](https://help.1inch.io/en/articles/4767696-how-to-participate-in-1inch-network-dao-governance):** A form of staking where community members can lock up their 1inch tokens in exchange for the right to vote on various parameters of DeFi protocols. _(Note: 1inch Network does not issue governance staking rewards)_
...
**[Price Impact](https://help.1inch.io/en/articles/4585109-what-is-price-impact-vs-price-slippage-in-defi):** Price impact is the influence that a trade has over the market price of the underlying asset pair. It is directly correlated with the amount of liquidity/volume in the pool.
...
**[Slippage Tolerance](https://help.1inch.io/en/articles/4585126-what-is-the-slippage-tolerance-setting):** The amount of slippage, in % terms, that you are willing to allow for a trade.
...
**[Swap](https://help.1inch.io/en/articles/4585153-how-to-swap-tokens-with-legacy-mode-on-1inch-network):** The act of transferring one asset in return for another at a designated rate.
...
**[Whitelisted token](https://help.1inch.io/en/articles/4878336-how-to-get-a-token-listed-on-1inch):** A token that has passed the rigorous process of review by the 1inch Foundation. All non-whitelisted tokens are considered “custom tokens” and are to be traded at the users’ own risk.
