...
1. [Gain enough unicorn power](#staking-and-delegation) to be listed among the registered resolvers. To register you must have at least 5% of all circulating unicorn power. There are two options available to grow your unicorn power:
...
More details can be found [here](./resolver-verification.mdx).
